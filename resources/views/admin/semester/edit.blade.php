...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                <form id="editSemesterForm" method="post" action="{{ route('admin.semester_update') }}">
                        @csrf
                        <input type="hidden" name="id" value="{{$semesterData->semester_id}}" class="form-control">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-xl-4">
                                    <div class="mb-3">
                                        ...
                                        @foreach ($courseData as $course) 
                                             @if($semesterData->course_id == $course->course_id) 
                                ...
                                <div class="col-xl-4">
                                    <div class="mb-3">
                                        <label for="semester_name" class="form-label">Semster Name</label>
                                        <input type="text" id="semester_name" value="{{$semesterData->semester_name}}" name="semester_name" class="form-control" placeholder="Enter Semster Name">
                                    </div>
                                </div>
                            </div>
                        </div>
