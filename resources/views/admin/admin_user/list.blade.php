        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    @if(Auth::guard('admin')->user()->hasPermissionTo('user-create'))
                    <div class="page-title-right">
                        <a href="{{ route('admin.admin_user_add') }}" class="btn btn-danger waves-effect waves-light"><i class="mdi mdi-plus-circle me-1"></i> Add New</a>
                    </div>
                    @endif
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td id="tooltip-container">
                                        ...
                                        @if(Auth::guard('admin')->user()->hasPermissionTo('user-edit'))
                                        <a href="{{ URL::to('admin/edit-user').'/'.$user->admin_id }}" class="action-icon" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"> <i class="mdi mdi-square-edit-outline"></i></a>
                                        @endif
