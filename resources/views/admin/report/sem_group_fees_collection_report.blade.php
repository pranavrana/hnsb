        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Sem Wise & Group Wise Fees Collection Report</h4>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        @if (!empty($feesData) && count($feesData))
                            <div class="text-center mt-3">
                                <a href="{{ route('admin.sem_group_fees_collection_report_export', request()->all()) }}" class="btn btn-success">Export to Excel</a>
                            </div>
                        @endif
                    </div> <!-- end card body-->
                </div> <!-- end card -->
