        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Fee Head-Wise Degree-Wise Audit Report</h4>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        @if (isset($feesData) && count($feesData))
                            <div class="text-center mt-3">
                                <a href="{{ route('admin.fee_head_degree_audit_report_print', request()->all()) }}" class="btn btn-success" target="_blank">Print</a>
                            </div>
                        @endif
                    </div> <!-- end card body-->
                </div> <!-- end card -->
