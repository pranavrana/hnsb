        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Sem - Wise & Cast Report All Student(Admitted Only)</h4>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        @if(request()->get('academic_year_id') !== null && request()->get('course_id') !== null && request()->get('semester_id') !== null)
                            <div class="alert alert-primary">
                                Caste-wise Report of Academic Year: {{ $selectedYear ?? '-' }} - Degree: {{ $selectedCourse ?? '-' }} - Semester: {{ $selectedSemester ?? '-' }} - All Group
                            </div>
                        @endif
