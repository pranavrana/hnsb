                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <a href="{{ route('admin.admission_requests') }}" class="btn btn-secondary waves-effect waves-light">
                                <i class="mdi mdi-arrow-left me-1"></i> Back
                            </a>
                        </div>
                        <h4 class="page-title">Edit Admission Request</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            <div class="row">
                <div class="col-xl-12 col-lg-12">
                    ...
                    <div class="card d-block">
                        <div class="card-body">
                            <form id="admissionForm" method="post" action="{{ route('admin.editAdmissionRequestData') }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-3">
                                                    <div class="form-check mb-2">
                                                        <input class="form-check-input" type="radio" name="gender"
                                                            id="male" value="Male" @if($studentData->gender == 'Male') {{'checked=""';}} @endif>
                                                ...
                                                <div class="col-xl-6">
                                                    <div class="form-check mb-2">
                                                        <input class="form-check-input" type="radio" name="gender"
                                                            id="female" value="Female" @if($studentData->gender == 'Female') {{'checked=""';}} @endif>
                                    ...
                                    <div class="col-xl-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control datepicker" name="birth_date"
                                                ...
                                                data-date-autoclose="true" data-date-format="dd-mm-yyyy" value="{{ $studentData->birth_date }}">
                                        </div>
                                    </div>
                                    <div class="col-xl-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="caste" name="caste">
                                                <option value="" @if($studentData->caste == '') {{'selected=""';}} @endif>Please Select Caste</option>
                                                <option value="1" @if($studentData->caste == '1') {{'selected=""';}} @endif>General</option>
                                                <option value="2" @if($studentData->caste == '2') {{'selected=""';}} @endif>OBC</option>
                                                <option value="3" @if($studentData->caste == '3') {{'selected=""';}} @endif>SC</option>
                                                <option value="4" @if($studentData->caste == '4') {{'selected=""';}} @endif>ST</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-xl-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-1">
                                    @if(isset($studentData->user->student_photo) && !empty($studentData->user->student_photo))
                                        <img src="{{ asset('uploads/student_photo/' . $studentData->user->student_photo) }}"  class="img-fluid rounded" width="250"/>
                                    @endif
                                    </div>
                                    <div class="col-xl-4">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-xl-1">
                                        @if(isset($studentData->user->student_sign) && !empty($studentData->user->student_sign))
                                    ...
                                    <div class="col-xl-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control datepicker" name="join_date"
                                                data-provide="datepicker" placeholder="DD-MM-YYYY"
                                                data-date-autoclose="true" data-date-format="dd-mm-yyyy" value="{{ $studentData->join_date }}">
                                    ...
                                    <div class="col-xl-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control datepicker" name="leaving_date"
                                                data-provide="datepicker" placeholder="DD-MM-YYYY"
                                                data-date-autoclose="true" data-date-format="dd-mm-yyyy" value="{{ $studentData->leaving_date }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-xl-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="passing_year"
                                                ...
                                                data-date-min-view-mode="2" data-date-autoclose="true" value="{{ $studentData->passing_year }}">
