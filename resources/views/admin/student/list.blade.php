                                        ...
                                        @foreach ($studentsData as $key => $student)
                                            <tr>
                                                ...
                                                <td id="tooltip-container">
                                                    ...
                                                    {{-- 
                                                     --}}
                                                    @if(Auth::guard('admin')->user()->hasPermissionTo('student-edit'))
                                                    ...
                                                    @endif
                                                    @if(Auth::guard('admin')->user()->hasPermissionTo('student-delete'))
                                                    <a href="javascript:void(0);" class="action-icon" data-bs-container="#tooltip-container"
                                                            data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"> <i class="mdi mdi-delete"></i></a>
                                                    @endif
                                                    {{-- @if(Auth::guard('admin')->user()->hasPermissionTo('student-delete')) --}}
                                                    <a href="{{ URL::to('admin/reset-student-login-credentials').'/'.$student->id }}" class="action-icon" data-bs-container="#tooltip-container"
                                                            data-bs-toggle="tooltip" data-bs-placement="top" title="Reset Credentials"> <i class="mdi mdi-lock-reset"></i></a>
                                                    {{-- @endif --}}
                                                </td>
                                            </tr>
                                        @endforeach
