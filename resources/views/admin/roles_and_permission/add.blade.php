...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form id="addRolesAndPermission" method="post" action="{{ route('admin.roles_and_permission_insert') }}">
                        @csrf
                        <div class="card-body">
                            <!-- <div class="row"> -->
                            <div class="col-xl-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="form-check mb-2 form-check-primary">
                                            <input name="permission[]" class="form-check-input rounded-circle" type="checkbox" value="{{$permission['id']}}" id="permission_{{$permission['id']}}">
...
<script>
    $(document).ready(function() {
        $('#addRolesAndPermission').validate({
