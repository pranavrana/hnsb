    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Add Admission Fees</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form id="addAdmissionForm" method="post" action="{{ route('admin.admission_fees_insert') }}">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-xl-3">
                                    ...
                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" min="0" id="admission_fees"
                                                name="admission_fees" class="form-control" placeholder="Enter Admission Fee">
                                        </div>
                                    </div>
                                    <div class="col-xl-3">
                                        <div class="mb-3">
