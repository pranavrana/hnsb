    ...
    <div class="content">
        ...
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <a href="{{ route('admin.fees_master') }}" class="btn btn-secondary waves-effect waves-light"><i
                                    class="mdi mdi-arrow-left me-1"></i> Back</a>
                        </div>
                        <h4 class="page-title">Add College Fees</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form id="addFeesMasterForm" method="post" action="{{ route('admin.fees_master_insert') }}">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-xl-3">
                                    ...
                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" onblur="calcTotalFee()" id="fee_tut" name="fee_tut"
                                                class="form-control" placeholder="Enter Tution Fee">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" onblur="calcTotalFee()" id="fee_lib" name="fee_lib"
                                                class="form-control" placeholder="Enter Library Fee">
                                        </div>
                                    </div>

                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            <label for="fee_sport_gim" class="form-label">Sports Games Fee
                                                (Gymkhana) <span class="text-danger">*</span></label>
                                            <input type="text" min="0" onblur="calcTotalFee()"
                                                id="fee_sport_gim" name="fee_sport_gim" class="form-control"
                                                placeholder="Enter Sports Games Fee (Gymkhana)">
                                        </div>
                                    </div>
                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" min="0" onblur="calcTotalFee()"
                                                id="fee_sport_clg" name="fee_sport_clg" class="form-control"
                                                placeholder="Enter Sports Fee (College)">
                                        </div>
                                    </div>

                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            <label for="fee_clgexam_stat" class="form-label">College Exam Stationary
                                                Fee <span class="text-danger">*</span></label>
                                            <input type="text" min="0" onblur="calcTotalFee()"
                                                id="fee_clgexam_stat" name="fee_clgexam_stat" class="form-control"
                                                placeholder="Enter College Exam Stationary Fee">
                                        </div>
                                    </div>
                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" min="0" onblur="calcTotalFee()"
                                                id="fee_student_rahat" name="fee_student_rahat" class="form-control"
                                                placeholder="Enter Student Relief Fee">
                                        </div>
                                    </div>
                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            <label for="fee_clg_dev" class="form-label">College Campus Development
                                                Fee <span class="text-danger">*</span></label>
                                            <input type="text" min="0" onblur="calcTotalFee()"
                                                id="fee_clg_dev" name="fee_clg_dev" class="form-control"
                                                placeholder="Enter College Campus Development Fee">
                                        </div>
                                    </div>
                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" min="0" onblur="calcTotalFee()"
                                                id="fee_you_fas" name="fee_you_fas" class="form-control"
                                                placeholder="Enter Youth Festival & Cult.Fee">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" min="0" onblur="calcTotalFee()" id="fee_med"
                                                name="fee_med" class="form-control" placeholder="Enter Medical Fee">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" min="0" onblur="calcTotalFee()"
                                                id="fee_hb_rasi" name="fee_hb_rasi" class="form-control"
                                                placeholder="Enter Hepatitis B Vaccine  Fee">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" min="0" onblur="calcTotalFee()" id="fee_union"
                                                name="fee_union" class="form-control"
                                                placeholder="Enter Student Union Fee">
                                        </div>
                                    </div>
                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            <label for="fee_reg" class="form-label">Admission Fee <span class="text-danger">*</span></label>
                                            <input type="text" min="0" onblur="calcTotalFee()" id="fee_reg"
                                                name="fee_reg" class="form-control" placeholder="Enter Admission Fee">
                                        </div>
                                    </div>
                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            <label for="fee_enroll" class="form-label">Enrolment Fee <span class="text-danger">*</span></label>
                                            <input type="text" min="0" onblur="calcTotalFee()" id="fee_enroll"
                                                name="fee_enroll" class="form-control" placeholder="Enter Enrolment Fee">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" min="0" onblur="calcTotalFee()" id="fee_icard"
                                                name="fee_icard" class="form-control" placeholder="Enter I-Card Fee">
                                        </div>
                                    </div>
                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" min="0" onblur="calcTotalFee()"
                                                id="fee_uniother" name="fee_uniother" class="form-control"
                                                placeholder="Enter Uni.Other Fee">
                                        </div>
                                    </div>
                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            <label for="fee_theal" class="form-label">Thalassemia Testing Fee <span class="text-danger">*</span></label>
                                            <input type="text" min="0" onblur="calcTotalFee()" id="fee_theal"
                                                name="fee_theal" class="form-control"
                                                placeholder="Enter Thalassemia Testing Fee">
                                        </div>
                                    </div>
                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            <label for="fee_lab" class="form-label">Laboratory Fee <span class="text-danger">*</span></label>
                                            <input type="text" min="0" onblur="calcTotalFee()" id="fee_lab"
                                                name="fee_lab" class="form-control" placeholder="Enter Laboratory Fee">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" min="0" onblur="calcTotalFee()"
                                                id="fee_uni_exam_form" name="fee_uni_exam_form" class="form-control"
                                                placeholder="Enter Uni.Exam Form Fee">
                                        </div>
                                    </div>
                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" min="0" onblur="calcTotalFee()"
                                                id="fee_uniexam" name="fee_uniexam" class="form-control"
                                                placeholder="Enter Uni.Exam Fee">
                                        </div>
                                    </div>
                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            <label for="fee_comp" class="form-label">Computer Fee <span class="text-danger">*</span></label>
                                            <input type="text" min="0" onblur="calcTotalFee()" id="fee_comp"
                                                name="fee_comp" class="form-control" placeholder="Enter Computer Fee">
                                        </div>
                                    </div>
                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            <label for="fee_ele" class="form-label">Ele.Gen.Fee <span class="text-danger">*</span></label>
                                            <input type="text" min="0" onblur="calcTotalFee()" id="fee_ele"
                                                name="fee_ele" class="form-control" placeholder="Enter Ele.Gen.Fee">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" min="0" onblur="calcTotalFee()" id="fee_other"
                                                name="fee_other" class="form-control"
                                                placeholder="Enter On-line Computer S/W Fee">
                                        </div>
                                    </div>
                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" min="0" onblur="calcTotalFee()"
                                                id="scope_exam_fee" name="scope_exam_fee" class="form-control"
                                                placeholder="Enter Scope Exam Fee">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" min="0" onblur="calcTotalFee()" id="total_fee"
                                                name="total_fee" class="form-control" placeholder="Enter Total" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control datepicker" name="cutoff_date"
                                    ...
                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" min="0" id="fee_late" name="fee_late"
                                                class="form-control" placeholder="Enter Late Fee">
                                        </div>
                                    </div>
                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-xl-3">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check form-switch">
                                                <input type="checkbox" class="form-check-input" value="1" name="cutoff_extension_status">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@push('scripts')
    ...
    <script>
        function calcTotalFee() {
            ...
            var result = parseInt(fee_other) + parseInt(fee_ele) + parseInt(fee_comp) + parseInt(fee_uniexam) + parseInt(
                    fee_uni_exam_form) + parseInt(fee_tut) + parseInt(fee_lib) + parseInt(fee_sport_gim) + parseInt(
                    fee_sport_clg) + parseInt(fee_clgexam_stat) + parseInt(fee_student_rahat) + parseInt(fee_clg_dev) +
                parseInt(fee_you_fas) + parseInt(fee_med) + parseInt(fee_hb_rasi) + parseInt(fee_union) + parseInt(
                fee_reg) + parseInt(fee_enroll) + parseInt(fee_icard) + parseInt(fee_uniother) + parseInt(fee_theal) +
                parseInt(fee_lab) + parseInt(scope_exam_fee);
        ...
        $(document).on('change', '#course_id', function() {
            ...
            if (course_id != "") {
                $.ajax({
                    ...
                    data: "ajax=true&course_id=" + course_id,
                    dataType: "json",
                    beforeSend: function() {
                        $("#semester_id").val('');
