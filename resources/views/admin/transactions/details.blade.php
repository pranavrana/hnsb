                ...
                <div class="col-12">
                    <div class="page-title-box">
                        <div class="page-title-right">
                                <a href="{{ url()->previous() }}" class="btn btn-secondary waves-effect waves-light">
                                    <i class="mdi mdi-arrow-left me-1"></i> Back
                                </a>
                                @if($transaction->payment_type == 2)
                                    <a href="{{ route('admin.download_college_fee_receipt', ['id' => $transaction->transaction_id]) }}" class="btn btn-primary waves-effect waves-light">
                        ...
                        <div class="card d-block">
                            <div class="card-body">
                                ...
                                {{-- <div class="row"> --}}
                                    ...
                                    <div class="col-md-4">
                                        <!-- assignee -->
                                        <label class="mt-2 mb-1">Fees Collected By :</label>
